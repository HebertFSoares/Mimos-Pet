...
public record AnimalsRequest(String name, AnimalSpecies species, String breed, Gender gender, AnimalSize size, Integer years, Boolean castrated, String photoUrl, String history) {
}
